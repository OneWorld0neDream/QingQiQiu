...
import com.framework.magicarena.pulltorefresh.PullToRefreshBase.OnPullEventListener;
import com.framework.magicarena.pulltorefresh.PullToRefreshBase.OnRefreshListener;
import com.framework.magicarena.pulltorefresh.PullToRefreshBase.OnRefreshListener2;
import com.framework.magicarena.pulltorefresh.PullToRefreshBase.State;

/**
 * <p>Interface that defines the operations that PullToRefreshView can execute.</p>
 *
...
public interface IPullToRefresh<T extends View> {
     ...
     *
     * @return true if the View is filtering Touch Events
     */
     ...
     * Note that you should not keep the result of this method any longer than you need
     * it.
     *
    ...
    /**
     * Indicate whether the 'Refreshing' View should be automatically shown when refreshing.
    ...
    /**
     * Get the state that this view is currently in.
     *
    ...
    /**
     * Indicate whether Pull-to-Refresh is enabled or not。
     *
     * @return enabled
     */
    ...
    /**
     * Returns whether the Widget is currently in the {@linkplain State#REFRESHING} or not.
     *
     ...
     *
     * @param mode {@linkplain Mode} to set the View to
     */
    void setMode(Mode mode);

    /**
     * Set {@linkplain OnPullEventListener} for the Widget.
     *
    ...
    /**
     * Set {@linkplain OnRefreshListener} for the Widget.
     *
    ...
    /**
     * Sets whether {@linkplain View} Overscroll support is enabled. This is different to
     * Android's standard {@linkplain View} Overscroll support (the edge-glow). This setting only
     * takes effect when running on device with Android v2.3 or greater.
     *
     * @param enabled true if you want {@linkplain View} Overscroll enabled
     */
     ...
     * This method can change this behaviour.
     *
     ...
     *
     * @param showView true to enable automatic refreshing
     */
