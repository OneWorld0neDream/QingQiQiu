...
public class PullToRefreshListView extends PullToRefreshAdapterViewBase<ListView> {
	...
	private AbsLoadingLayout mHeaderLoadingView;
	private AbsLoadingLayout mFooterLoadingView;
	...
	protected void onRefreshing(final boolean doScroll) {
		...
		final AbsLoadingLayout origLoadingView, listViewLoadingView, oppositeListViewLoadingView;
	...
	protected void onReset() {
		...
		final AbsLoadingLayout originalLoadingLayout, listViewLoadingLayout;
