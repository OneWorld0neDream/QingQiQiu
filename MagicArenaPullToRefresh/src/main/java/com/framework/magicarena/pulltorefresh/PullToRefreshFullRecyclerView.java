 ...
 * </table>
 */
public class PullToRefreshFullRecyclerView extends PullToRefreshBase<FullDisplayRecyclerView> {
    public PullToRefreshFullRecyclerView(Context context) {
        super(context);
    }

    public PullToRefreshFullRecyclerView(Context context, AttributeSet attrs) {
        super(context, attrs);
    }

    public PullToRefreshFullRecyclerView(Context context, Mode mode) {
        super(context, mode);
    }

    public PullToRefreshFullRecyclerView(Context context, Mode mode, AnimationStyle animStyle) {
     ...
     */
    @Override
    protected FullDisplayRecyclerView createRefreshableView(Context context, AttributeSet attrs) {
        FullDisplayRecyclerView recyclerView = new FullDisplayRecyclerView(context, attrs);
