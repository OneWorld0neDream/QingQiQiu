...
import com.framework.magicarena.pulltorefresh.internal.Utils;
import com.framework.magicarena.pulltorefresh.internal.ViewCompat;
...
public abstract class PullToRefreshBase<T extends View> extends LinearLayout implements IPullToRefresh<T> {
    ...
    protected AbsLoadingLayout createLoadingLayout(Context context, Mode mode, TypedArray attrs) {
        AbsLoadingLayout layout = mLoadingAnimationStyle.createLoadingLayout(context, mode,
    ...
    protected final AbsLoadingLayout getFooterLayout() {
    ...
    protected final AbsLoadingLayout getHeaderLayout() {
    ...
    public static enum AnimationStyle {
        ...
        AbsLoadingLayout createLoadingLayout(Context context, Mode mode, Orientation scrollDirection, TypedArray attrs) {
            switch (this) {
                case ROTATE:
                default:
