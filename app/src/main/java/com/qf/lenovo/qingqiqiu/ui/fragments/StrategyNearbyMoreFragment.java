...
public class StrategyNearbyMoreFragment extends BaseFragment implements SwipeRefreshLayout.OnRefreshListener {
    ...
    private void setupView() {
        RequestCall build = OkHttpUtils.get()
                ...
                .addParams(HttpRequestURL.STRATEGY_NEARBY_LOCATIONS_REQUEST_PARAM_LAT, this.mLocationLat)
                .addParams(HttpRequestURL.STRATEGY_NEARBY_LOCATIONS_REQUEST_PARAM_LNG, this.mLocationLng)
                .build();
        build
    ...
    public View onCreateView(LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        this.mFragmentLayout = inflater.inflate(R.layout.fragment_strtegy_nearby_more, container, false);
