 ...
 */
public class DetailNearbyAdapter extends RecyclerSingleViewGeneralAdapter<TripDetailModel.DataBean.SectionsBean.ModelsBean> {
    /**
     ...
     */
    public DetailNearbyAdapter(Context context, List<TripDetailModel.DataBean.SectionsBean.ModelsBean> data, int layoutResId) {
    ...
    protected void bindDataSource(ViewHolder holder, TripDetailModel.DataBean.SectionsBean.ModelsBean item, int position) {
        ...
        holder.setViewText(R.id.detail_nearby_item_distance,item.getSummary());
    }
}
