...
public class StrategyNearbyLocationsListModel {
    ...
    private int status;
    private List<StrategyNearbyLocationsItem> data;
    ...
    public List<StrategyNearbyLocationsItem> getData() {
        return data;
    }

    public void setData(List<StrategyNearbyLocationsItem> data) {
        this.data = data;
    }

    public static class StrategyNearbyLocationsItem {
        private int id;
        private double lat;
        private double lng;
